    ...
    return (
        <>
            ...
            <Modal.Body>
                ...
                <p>ราคา: {selectedBooking.totalPrice}</p>
  ...
  const handleBookingAction = (booking) => {
    ...
    const handleSearch = () => {
        const filtered = data.filter(item =>
            ...
            (item.bookingtype === 'จอง' || item.bookingtype === 'กำลังเข้าพัก')
        );
            ...
            <div>
                ...
                <div className="card-Hotel">
                    ...
                    <div className='bar-card-box'>
                        <button className='bar-card-box-h-11'>การจองที่พัก</button>
                        <button onClick={clickbookh} className='bar-card-box-h-111'>ประวัติการจอง</button>
                    </div>
                </div>
                                ...
                                <tr key={i}>
                                    ...
                                    <td>
                                        <button className='kub-button-3' onClick={() => handleShowModal(item)}>
                                            {item.bookingtype === 'กำลังเข้าพัก' ? 'ออกจากห้อง' : 'เข้าพัก' }
                                        </button>
                                    </td>
                                </tr>
                            ))}
